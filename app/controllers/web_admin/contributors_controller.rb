class WebAdmin::ContributorsController < ApplicationController
  ...
  def contributor_paramas
    params.require(:contributor).permit(:last_name, :first_name, :last_name_kana, :first_name_kana, :brand_name, :profile_image, :profile_image, :email, :postal_code, :address, :telephone_number, :is_deleted)
  end
